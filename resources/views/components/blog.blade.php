...
<head>
    ...
    <title>Nalar Muda — Blog Berita</title>
...
<body class="bg-slate-50 text-slate-800">
    ...
    <!-- ============================================================ -->
    <!-- NAVBAR — pisahkan ke: resources/views/components/navbar.blade.php -->
    <!-- ============================================================ -->
    <nav class="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            <div class="brand text-2xl font-bold text-slate-900">Nalar Muda</div>
            <ul class="flex gap-8 text-sm font-medium text-slate-600">
                <li><a href="/" class="text-slate-900 font-semibold border-b-2 border-slate-900 pb-0.5">Beranda</a></li>
                <li><a href="/nasional" class="hover:text-slate-900 transition">Nasional</a></li>
                <li><a href="/internasional" class="hover:text-slate-900 transition">Internasional</a></li>
                <li><a href="/teknologi" class="hover:text-slate-900 transition">Teknologi</a></li>
                <li><a href="/olahraga" class="hover:text-slate-900 transition">Olahraga</a></li>
            </ul>
            <div class="flex items-center gap-3">
                <input type="text" placeholder="Cari berita..." class="text-sm border border-slate-200 rounded-full px-4 py-2 w-48 focus:outline-none focus:ring-2 focus:ring-slate-300">
            </div>
        </div>
    </nav>
    <!-- ============================================================ -->
    ...
    <!-- ============================================================ -->
    <!-- HEADER — pisahkan ke: resources/views/components/header.blade.php -->
    <!-- ============================================================ -->
    <header class="bg-slate-900 text-white py-10 mb-10">
        <div class="max-w-6xl mx-auto px-6">
            <p class="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-2">Rabu, 15 Mei 2026</p>
            <h1 class="text-4xl font-bold mb-2">Berita Terkini</h1> <!-- {{ $slot }} di Blade -->
            <p class="text-slate-400 text-sm">Informasi terpercaya, analisis mendalam, setiap hari.</p>
        </div>
    </header>
    <!-- ============================================================ -->
    <!-- AKHIR HEADER                                                  -->
    ...
    <!-- ============================================================ -->
    <!-- KONTEN HOME — pisahkan ke: resources/views/home.blade.php    -->
    <!-- ============================================================ -->
    ...
    <!-- ============================================================ -->
    <!-- FOOTER — pisahkan ke: resources/views/components/footer.blade.php -->
    <!-- ============================================================ -->
    <footer class="bg-slate-900 text-slate-400 mt-16 py-12">
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid md:grid-cols-4 gap-8 mb-10">
                <div class="md:col-span-2">
                    <div class="brand text-2xl font-bold text-white mb-3">Nalar Muda</div>
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-2 text-sm">
                        <li><a href="#" class="hover:text-white transition">Nasional</a></li>
                        <li><a href="#" class="hover:text-white transition">Internasional</a></li>
